...
class Color_Magazine_Social_Media extends WP_widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname'         => 'color_magazine_social_media',
            'description'       => __( 'A widget shows the social media icons.', 'color-magazine' ),
            'customize_selective_refresh'   => true,
        );
        parent::__construct( 'color_magazine_social_media', __( 'MT: Social Media', 'color-magazine' ), $widget_ops );
    }
